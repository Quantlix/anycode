...
def command(
    target: str = typer.Argument(
        "tools",
        help="What to inspect: 'tools', 'providers', 'team <path>', or 'config <path>'.",
    ),
...
def _show_providers(console: Console) -> None:
    providers = ["anthropic", "openai", "google", "ollama", "azure", "bedrock"]
    console.print("[bold]Supported providers:[/bold] " + ", ".join(providers))
