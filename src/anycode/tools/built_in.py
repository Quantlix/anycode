...
from anycode.tools.list_files import list_files_tool
from anycode.tools.registry import ToolRegistry
from anycode.types import ToolDefinition

BUILT_IN_TOOLS: list[ToolDefinition] = [bash_tool, file_read_tool, file_write_tool, file_edit_tool, grep_tool, list_files_tool]
